  ...
  async function deleteWishlistItem(id) {
    ...
    return new Promise((resolve) => {
      setTimeout(() => {
        ...
        // This would be an expensive delete operation if the array becomes quite large. Probably fine for a wishlist but not for a "Collection" or product notes tracker.
    ...
    <Page title="Wishlist">
      <Grid columns={["fill", "fill", "fill"]} rows="auto" spacing="loose">
        ...
        {!loading && wishlist.length === 0 && (
          <TextBlock>No items in your collection.</TextBlock>
        )}
      </Grid>
    </Page>
  );
